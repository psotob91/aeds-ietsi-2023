...
## PRIMERA PARTE: Análisis descriptivo univariado de datos numéricos
...
## SEGUNDA PARTE: Análisis descriptivo bivariado de datos numéricos
...
## TERCERA PARTE: Análisis descriptivo univariado de datos categóricos

### Ejercicio 11 {.unnumbered}

Crear una tabla con las frecuencias absoluta y relativa del sexo, primero con los NA y luego excluyendo los NA: 
...
Genere una tabla descriptiva para comorbilidades:
...
Genere una tabla descriptiva para el tipo de refuerzo recibido, excluya los NA:
...
## CUARTA PARTE: Análisis descriptivo bivariado de datos categóricos
...
## QUINTA PARTE: Gráficos comparativos para datos numéricos y categóricos
...
## SEXTA PARTE: Análisis descriptivo univariado de datos numéricos
